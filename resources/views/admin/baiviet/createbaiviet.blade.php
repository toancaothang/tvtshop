    ...
    <div class="content" style="padding-top: 10px; padding-bottom:0px">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <h4>Thêm mới loại bài viết</h4>
                <form class="mb-5" method="POST" action="{{route('xylythemDMBV')}}" style="margin-left :20px">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label for="" class="col-form-label">Tên danh mục *</label>
                            <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Nhập tên danh mục bài viết" required>
                        </div>
                    </div>
                    <div class="row">
