                ...
                <form class="mb-5" method="POST" acction="{{route('xylysuaBV',['BV'=>$thongtin->id])}}" style="margin-left :20px" enctype = multipart/form-data>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group mb-12">
                            ...
                            <textarea style="height:auto" class="form-control" name="title" id="title" required>{{ $thongtin->title }}</textarea>

                        </div>
                        <div class="col-md-12 form-group mb-12">
                            <label for="" class="col-form-label">Nội dung</label>
                            <textarea style="height:200px" type="text" class="form-control" name="content" id="content"  placeholder="Nhập nội dung bài viết" required>{{ $thongtin->content }}</textarea>
                        </div>
                        <div class="col-md-12 form-group mb-12">
