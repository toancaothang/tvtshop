...
<section class="recent" style="margin-top: 0px;">     
    <h2 class="dash-title">Quản lý bình luận</h2>
    <hr>
    <section class="recent" style="margin-top: 3px">
      <form method="GET" id="header-search" action="{{route('xylytkBL')}}">
                        ...
                        <tbody>
                          @foreach ($dsbinhluan as $a)
                            <tr>
                              ...
                              <td>{{$a->stars}}</td>
                              <td>
                                {{-- <a href="{{$a->comment_name}}" class="button type2">Phản hồi</a> --}}
                                <a href="{{route('xylyxoaBL',['BL'=>$a->id])}}" class="button type2">Xoá</a>
                              </td>
                            </tr>
                          @endforeach  
                        </tbody>
