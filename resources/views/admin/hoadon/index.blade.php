...
<section class="recent" style="margin-top: 0px;">     
    <h2 class="dash-title">Quản lý hoá đơn</h2>
    <hr>
        <section class="recent" style="margin-top: 3px">
          <form method="GET" id="header-search" action="{{route('xylytkHD')}}">
            <input style=" width:300px;display: inline-block; vertical-align: middle" type="text" name="name" id="name" class="form-control" placeholder="Nhập tên khách hàng" />
                        ...
                        <tbody>
                          @foreach ($dshoadon as $a)
                            ...
                            <span style="color:#d35400;">Đang xác nhận</span>
                              ...
                              <td>
                                <a href="{{route('SuaHD',['HD'=>$a->id])}}" class="button type2">Cập nhật</a>
                              </td>
                            </tr>
                          @endforeach  
                        </tbody>
