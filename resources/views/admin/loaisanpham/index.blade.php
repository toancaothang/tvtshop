...
<section class="recent" style="margin-top: 0px;">     
    ...
    <a style="margin-bottom: 0px;font-size:15px;margin-left:0px" class="button type2" href="{{route('formthemLSP')}}">Thêm mới</a>
    <hr>
    <section class="recent" style="margin-top: 3px">
          <form method="GET" id="header-search" action="{{route('xylytkLSP')}}">
            <input style=" width:300px;display: inline-block; vertical-align: middle" type="text" name="category_name" id="category_name" class="form-control" placeholder="Nhập tên loại sản phẩm" />
                        ...
                        <tbody id="listUser">
                          @foreach ($dsloaisanpham as $a)
                            <tr>
                              ...
                              <td>
                                <a href="{{route('SuaLSP',['LSP'=>$a->id])}}" class="button type2">Sửa</a>
