    ...
    <div class="content" style="padding-top: 10px; padding-bottom:0px">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <h4>Thêm mới mẫu sản phẩm</h4>
                <form class="mb-5" method="POST" action="{{route('xylythemmodelSP')}}" style="margin-left :20px" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="model_name" id="model_name"  placeholder="Nhập tên mẫu sản phẩm" required>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="opera_sys" id="opera_sys" placeholder="Nhập tên hệ điều hành" required>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="gpu" id="gpu" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label for="" class="col-form-label">Camera trước *</label>
                            <input type="text" class="form-control" name="front_camera" id="front_camera" required>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                          <label for="" class="col-form-label">Camera sau *</label>
                          <input type="text" class="form-control" name="back_camera" id="back_camera" required>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label for="" class="col-form-label">Khe cắm sim *</label>
                            <input type="text" class="form-control" name="sim" id="sim" required>
                        </div>
                        <div class="col-md-6 form-group mb-3">
