    ...
    <div class="content" style="padding-top: 10px; padding-bottom:0px">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <form class="mb-5" method="POST" action="{{route('xylythemNSX')}}" style="margin-left :20px">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label for="" class="col-form-label">Tên nhà sản xuất *</label>
                            <input type="text" class="form-control" name="ten_nsx" id="ten_nsx" placeholder="Nhập tên nhà sản xuất" required>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label for="" class="col-form-label">Thông tin *</label>
                            <input type="text" class="form-control" name="thong_tin" id="thong_tin"  placeholder="Nhập thông tin" required>
                        </div>
                    </div>
                    <div class="row">
